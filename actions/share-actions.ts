...
export async function shareListByEmail(listId: string, email: string) {
  try {
    ...
    await resend.emails.send({
      ...
      to: email,
      subject: `${senderName} shared a gift list with you on GiftFlow`,
      html: `
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <p style="font-size: 16px; color: #666;">
            ...
            "<strong>${listName}</strong>" with you on GiftFlow.
          </p>
          ...
          <p style="font-size: 12px; color: #999;">
            This invitation was sent from GiftFlow. If you did not expect this email, you can safely ignore it.
          </p>
        </div>
      `,
    });
